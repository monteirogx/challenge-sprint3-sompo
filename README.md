...
- <b>assets</b>: aqui estão os arquivos relacionados a elementos não-estruturados deste repositório, como imagens. Ex: ### Arquitetura da Solução
![Diagrama de Arquitetura do Sistema](assets/diagrama_de_arquitetura.jpg)
